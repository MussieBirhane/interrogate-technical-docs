...
with st.sidebar:
    ...
    st.write(
        "Developed by [Aleksei Kondratenko](https://www.linkedin.com/in/aleksei-kondratenko-14a2a0192/) & [Mussie Birhane](https://www.linkedin.com/in/mussie-birhane-92b0ba156/)"
    )

# get your OPENAI_API_KEY
_ = load_dotenv(find_dotenv())  # read local .env file
openai.api_key = os.getenv("OPENAI_API_KEY")
# Alternatively (uncomment if used and comment an upper row)
# os.environ["OPENAI_API_KEY"] = "your API key"


def main():
    st.header("Interrogate your technical documents")
    # Upload a PDF file
    ...
    if pdf is not None:
        ...
        if query := st.chat_input("Send a message"):
            ...
            with st.spinner("Retrieving..."):
                final_prompt = prompt_template.format_messages(style=style, text=query)
